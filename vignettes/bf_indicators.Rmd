...
Again, we will make some manual checking on whether the result we got from `get_eibf` was correct or not. 102 children met the indicator definition conditions, the other 33 did not, and 8 observations had missing information on the variable required for the `q2` parameter. 
