...
final_var <- c(
  'csex', 'calc_age_months', 'child_bf', 'child_eibf',
  'child_eibf_hrs', 'child_eibf_days', 'bf_2days', 'child_bfyest',
  'bf_bottle', 'child_water', 'child_bms', 'child_bms_freq', 'child_milk',
  'child_milk_freq', 'child_milk_sweet', 'child_mproduct', 'child_mproduct_freq', 
  'child_mproduct_sweet', 'child_chocolate', 'child_juice', 'child_soda',
  'child_tea', 'child_tea_sweet', 'child_broth', 'child_oth_drink',
  'child_oth_drink_sweet', 'child_yogurt', 'child_yogurt_frq', 'child_rice',
  'child_pumpkin', 'child_potatoes', 'child_leafyveg', 'child_oth_veg',
  'child_mango', 'child_fruit', 'child_organ', 'child_processmeat', 'child_beef', 
  'child_eggs', 'child_fish', 'child_beans', 'child_cheese', 'child_sweets',
